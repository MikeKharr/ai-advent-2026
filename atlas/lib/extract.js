...
// `agent_docs/design/2026-09-10-0550-project-atlas.md`. Источник не меняется —
// граф извлекается из действующих соглашений цитирования (ADR 2026-09-10-0550).
...
export function buildGraph(sources) {
  ...
  // (контракт 1 этапа 3, раскладка 2026-09-10-1155).
  const placed = layout(nodes, edges)
  // Глубина — после плоскости и при зафиксированных x, y (ADR 2026-09-10-1420).
