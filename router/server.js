...
const router = createRouter({ config, registry: createStaticRegistry(config.providers), log, env })
const ledger = createLedger({ file: env.ROUTER_LEDGER_FILE ?? join(here, 'data', 'ledger.jsonl') })
