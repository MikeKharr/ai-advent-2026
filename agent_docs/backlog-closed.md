...
- [x] 2026-09-11 — атлас: ребро `routes` caddy → atlas. Маршрут извлекается из любого `reverse_proxy <service>:<port>` в Caddyfile, не только `/dayN/`; лендинг и `/progress/` — файлы `site`, их покрывает `serves` (класс B). → `design/2026-09-13-2000-project-atlas.md`, таблица рёбер
