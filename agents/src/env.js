...
const NUMBERS = {
  ...
  // Профиль дня 11 живёт дольше своих диалогов: настройки, правила и темы
  // переживают переписку (решение владельца 7, ADR 2026-09-15-2024).
  PROFILE_TTL_DAYS: 30,
  // Потолок живых профилей (решение владельца 8): шестой не создаётся.
  PROFILE_CAP: 5,
