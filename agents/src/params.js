...
/**
 * Инварианты профиля дня 14 (ADR 2026-09-22-0827, п. 2): сколько их бывает в
 * профиле и какой длины бывает один. Потолок — временное рабочее значение,
 * как 40 правил и 60 фактов; 200 знаков — решение владельца, не отраслевой
 * стандарт. Одно число на хранилище, промпт формулировщика и ручку приёма:
 * тремя копиями они разошлись бы молча.
 */
export const PROFILE_INVARIANT_CAP = 10
export const INVARIANT_CHARS = 200
