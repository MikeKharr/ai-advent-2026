...
// настройки двух cookie дня 11: профиль (30 дней) и диалог (30 часов),
// ADR 2026-09-15-2024, п. 2.
...
export function parseEnv(source = process.env) {
  ...
  const env = {
    ...
    AGENT_ID: source.AGENT_ID || 'layered-agent',
    ...
    COOKIE_PATH: source.COOKIE_PATH || '/day11/',
