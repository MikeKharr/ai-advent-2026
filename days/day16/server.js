 ...
 * `noKey` его снимает — это и есть проба на 401. Остальные три заголовка
...
async function handleRpc(req, res) {
  ...
  res.writeHead(upstream.status, {
    'content-type': SAFE_CONTENT_TYPE.test(upstreamType) ? upstreamType : 'application/json; charset=utf-8',
    'cache-control': 'no-store',
