...
// настройки двух cookie дня 14: профиль (30 дней) и диалог (30 часов),
// ADR 2026-09-15-2024, п. 2; день 14 наследует их у дня 13
// (ADR 2026-09-22-0827, п. 7) со своими именами.
...
export function parseEnv(source = process.env) {
  ...
  const env = {
    ...
    COOKIE_PATH: source.COOKIE_PATH || '/day14/',
