// Вызов Messages API. Ответ — свободный текст: формат задаёт пользователь,
// поэтому строгая JSON-схема неприменима. Модель получает проверенный список
// новостей СО ссылками, а ссылки не из списка вырезаются постфактум
// (ADR 2026-09-07-2330). День 3 добавляет к параметрам температуру.
