...
└── agent_docs/               # Проектная документация
    ...
    ├── guides/               # Гайды (DoD, окружение, логирование, роли, Drive)
    └── templates/            # Шаблоны документов
```

## Состояние

Каркас документации и правил готов. **Прикладного кода ещё нет** — стек ожидает решения владельца по `agent_docs/adr/2026-09-07-1525-zero-dependency-node.md`. Что делать дальше — в `agent_docs/snapshot.md` и `agent_docs/backlog.md`.
...
- **Источник истины для решений — git.** Google Drive («AI advent Dev») — только читаемая витрина, правила синхронизации в `agent_docs/guides/drive-sync.md`.
